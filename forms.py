...
class CreateVendorForm(FlaskForm):
    organic = SelectField('Is your produce organic?', choices=['Yes', 'No', 'Somewhat', 'N/A'], validators=[InputRequired()])
    ...
    methods = SelectField('What are your methods of farming?', choices=['Sustainable', 'Unsustainable'], validators=[InputRequired()])
